...
const wchar_t* NPOINT_DOC_ID = L"your acout number";
...
int ContarRegistrosJson(const std::string& jn) {
    ...
    // BLINDAGEM: Verifica se é um JSON válido mínimo antes de contar
    if (jn.find("{\"data\":[") == std::string::npos) return 0;
    // Se terminar abruptamente sem fechar data, considera 0
    if (jn.rfind(']') < jn.rfind('{')) return 0;
